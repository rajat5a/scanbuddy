            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <x-common.common-grid-shape />
                        <a href="/" class="mb-4 block flex items-center gap-2">
                            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-500 text-white shadow-md">
                            ...
                            <span class="text-2xl font-bold tracking-wide text-white dark:text-white">
                                Scan<span class="text-brand-500">Buddy</span>
                            </span>
                        </a>
                    </div>
                </div>
