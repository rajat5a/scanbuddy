...
class MenuHelper
{
    public static function getMainNavItems()
    {
        return [
            ...
            [
                'name' => 'Menu Items',
                'icon' => 'tables', // Aapne 'tables' icon pehle se defined kiya hai
                'subItems' => [
                    ['name' => 'View All', 'path' => '/menu-items', 'pro' => false],
                    ['name' => 'Add New', 'path' => '/menu-items/create', 'pro' => false],
                ],
            ],
            [
                'name' => 'Categories',
                'icon' => 'forms', // Aap 'tag' icon bhi use kar sakte hain agar add karein
                'path' => '/categories',
            ],
        ];
    }
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'tag' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="2"/><path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="2"/><path d="M2 12L12 17L22 12" stroke="currentColor" stroke-width="2"/></svg>',
        ];
